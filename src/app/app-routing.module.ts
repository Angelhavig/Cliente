...
const routes: Routes = [
  ...
  { path: 'Vista/:id/Solicitante', component: VistaComponent, canActivate: [AuthGuard]},
  { path: 'Vista/:id/Testigo-Principal', component: VistaComponent, canActivate: [AuthGuard]},
  { path: 'Vista/:id/Testigo-Secundario', component: VistaComponent, canActivate: [AuthGuard]},
  { path: 'Vista/:id/Academia', component: VistaComponent, canActivate: [AuthGuard]},
