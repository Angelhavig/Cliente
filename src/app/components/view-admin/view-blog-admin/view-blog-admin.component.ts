...
@Component({
  selector: 'app-view-blog-admin',
  templateUrl: './view-blog-admin.component.html',
  styleUrls: ['./view-blog-admin.component.css']
})
export class ViewBlogAdminComponent implements OnInit{
  comment: FormGroup;
  maxDate: Date;
...
borrarComentario(id: number) {
  this._comentarioBlogService.deleteComment(id).subscribe(() => {
  })
