...
@Component({
  selector: 'app-view-empresa-admin',
  templateUrl: './view-empresa-admin.component.html',
  styleUrls: ['./view-empresa-admin.component.css']
})
export class ViewEmpresaAdminComponent implements OnInit{
  comment: FormGroup;
  maxDate: Date;
  ...
  borrarComentario(id: number) {
    this._ComentariosEmpresaService.deleteComment(id).subscribe(() => {
    })
